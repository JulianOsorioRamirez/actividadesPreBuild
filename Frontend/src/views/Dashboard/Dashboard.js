...
import styles from 'assets/jss/material-ui-react/views/dashboardStyle.js'
            ...
            <CardBody>
              <GridContainer justifyContent='space-between'>
                <GridItem xs={12} sm={12} md={5}>
                  <Table
                    tableData={[
                      [<img src={us_flag} alt='us_flag' key={'flag'} />, 'USA', '2.920', '53.23%'],
                      [<img src={de_flag} alt='us_flag' key={'flag'} />, 'Germany', '1.300', '20.43%'],
                      [<img src={au_flag} alt='us_flag' key={'flag'} />, 'Australia', '760', '10.35%'],
                      [<img src={gb_flag} alt='us_flag' key={'flag'} />, 'United Kingdom', '690', '7.87%'],
                      [<img src={ro_flag} alt='us_flag' key={'flag'} />, 'Romania', '600', '5.94%'],
                      [<img src={br_flag} alt='us_flag' key={'flag'} />, 'Brasil', '550', '4.34%'],
                    ]}
                  />
                </GridItem>
