...
import styles from 'assets/jss/material-ui-react/views/sweetAlertStyle.js'
  ...
  const htmlAlert = () => {
    setAlert(
      ...
      >
        ...
        <a href='https://actividades.com/?ref=mdpr-sweetalert-page' target='_blank'>
          links
        </a>{' '}
        and other HTML tags
      </SweetAlert>
      ...
      <Heading
        ...
        category={
          <span>
            ...
            <a target='_blank' href='https://github.com/djorg83?ref=creativetim'>
              Daniel Jorgensen
            </a>
            . Please check out the{' '}
            <a href='https://github.com/djorg83/react-bootstrap-sweetalert?ref=creativetim' target='_blank'>
              full documentation.
            </a>
            .
          </span>
          ...
          <Card>
            <CardBody>
              <div className={classes.center}>
                ...
                <Button color='rose' onClick={warningWithConfirmAndCancelMessage}>
                  Try me!
                </Button>
              </div>
            </CardBody>
