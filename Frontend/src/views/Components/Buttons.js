...
import styles from 'assets/jss/material-ui-react/views/buttonsStyle.js'
          ...
          <GridItem xs={12}>
            ...
            <div className={classes.cardContentBottom}>
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color='twitter'>
                    <i className={classes.socialButtonsIcons + ' ' + classes.marginRight + ' fab fa-twitter'} /> Connect
                    with Twitter
                  </Button>
                </GridItem>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color='google'>
                    <i className={classes.socialButtonsIcons + ' ' + classes.marginRight + ' fab fa-google-plus-g'} />{' '}
                    Share on Google+
                  </Button>
                </GridItem>
                <GridItem xs={12} sm={1} md={1}>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color='pinterest'>
                    <i className={classes.socialButtonsIcons + ' ' + classes.marginRight + ' fab fa-pinterest'} /> Pint
                    it · 212
                  </Button>
                </GridItem>
                <GridItem xs={12} sm={1} md={1}>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color='youtube'>
                    <i className={classes.socialButtonsIcons + ' ' + classes.marginRight + ' fab fa-youtube'} /> View on
                    Youtube
                  </Button>
                </GridItem>
                <GridItem xs={12} sm={1} md={1}>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color='github'>
                    <i className={classes.socialButtonsIcons + ' ' + classes.marginRight + ' fab fa-github'} /> Connect
                    with Github
                  </Button>
                </GridItem>
                <GridItem xs={12} sm={1} md={1}>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color='behance'>
                    <i className={classes.socialButtonsIcons + ' ' + classes.marginRight + ' fab fa-behance-square'} />{' '}
                    Follow us
                  </Button>
                </GridItem>
                <GridItem xs={12} sm={1} md={1}>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color='dribbble'>
                    <i className={classes.socialButtonsIcons + ' ' + classes.marginRight + ' fab fa-dribbble'} /> Find
                    us on Dribble
                  </Button>
                </GridItem>
                <GridItem xs={12} sm={1} md={1}>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color='reddit'>
                    <i className={classes.socialButtonsIcons + ' ' + classes.marginRight + ' fab fa-reddit'} /> Repost ·
                    232
                  </Button>
                </GridItem>
                <GridItem xs={12} sm={1} md={1}>
