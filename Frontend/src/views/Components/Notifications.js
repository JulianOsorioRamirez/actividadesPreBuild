...
import styles from 'assets/jss/material-ui-react/views/notificationsStyle.js'
      ...
      <Heading
        ...
        category={
          <span>
            ...
            <a target='_blank' href='https://material-ui-next.com/?ref=creativetim'>
              Material UI
            </a>{' '}
            and styled by{' '}
            <a target='_blank' href='https://actividades.com/?ref=mdpr-notifications-page'>
              ...
              <div>
                ...
                <GridContainer justify='center'>
                  <GridItem xs={12} sm={12} md={12} className={classes.center}>
                    ...
                    <Button color='primary' round className={classes.marginRight} onClick={() => setClassicModal(true)}>
                      Classic modal
                    </Button>
                    <Dialog
                      classes={{
                    ...
                    <Button color='info' round className={classes.marginRight} onClick={() => setNoticeModal(true)}>
                      Notice Modal
                    </Button>
                    <Dialog
                      classes={{
                    ...
                    >
                      ...
                      <DialogContent id='notice-modal-slide-description' className={classes.modalBody}>
                        <Instruction
                          ...
                          text={
                            <span>
                              ...
                              <a href='https://actividades.com/?ref=mdpr-notifications-page'>Agencia de Actividades</a>.
                        ...
                        />
                        <p>
                          If you have more questions, don{"'"}t hesitate to contact us or send us a tweet @creativetim.
                          We{"'"}
                          re here to help!
                        </p>
                      </DialogContent>
                    ...
                    <Button color='rose' round className={classes.marginRight} onClick={() => setSmallModal(true)}>
                      Small alert modal
                    </Button>
                    <Dialog
                      classes={{
