...
const dailySalesChart = {
  ...
  options: {
    ...
    low: 0,
    high: 50, // Evaluación y Desempeño : we recommend you to set the high sa the biggest value + something for a better look
    chartPadding: {
      top: 0,
      right: 0,
      bottom: 0,
...
const completedTasksChart = {
  ...
  options: {
    ...
    low: 0,
    high: 1000, // Evaluación y Desempeño : we recommend you to set the high sa the biggest value + something for a better look
    chartPadding: {
      top: 0,
      right: 0,
      bottom: 0,
