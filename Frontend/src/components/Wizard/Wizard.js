...
import wizardStyle from 'assets/jss/material-ui-react/components/wizardStyle.js'
            ...
            {steps.map((prop, key) => {
              ...
              return (
                <div className={stepContentClasses} key={key}>
                  <prop.stepComponent ref={(node) => (this[prop.stepId] = node)} allStates={this.state.allStates} />
                </div>
              )
            })}
          </div>
